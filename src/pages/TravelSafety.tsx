...
import { Camera, Radio, Eye, Shield, AlertTriangle, CheckCircle, MapPin, Smartphone, Menu } from "lucide-react";
      ...
      <footer className="bg-card border-t border-border py-12 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-0 mb-4">
                ...
                <h3 className="text-xl font-bold text-foreground">EncryptHer</h3>
              </div>
              <p className="text-sm text-muted-foreground">
                Empowering women through digital safety education and practical security training.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><a href="/#classes" className="text-muted-foreground hover:text-foreground transition-colors">All Classes</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link to="/donate" className="text-muted-foreground hover:text-foreground transition-colors">Support Us</Link></li>
              </ul>
            </div>
          ...
          <div className="border-t border-border pt-8 text-center text-sm text-muted-foreground">
            <p>&copy; 2024 EncryptHer. Empowering digital safety for all.</p>
          </div>
        </div>
      </footer>
    </div>
