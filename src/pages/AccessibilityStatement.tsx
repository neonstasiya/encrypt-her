        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <nav aria-label="Programs">
              <h2 className="font-semibold mb-4 text-foreground">Programs</h2>
            ...
            <nav aria-label="Connect">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground" role="list">
                ...
                <li><Link to="/accessibility" className="hover:text-foreground transition-colors focus:outline-none focus:ring-2 focus:ring-ring rounded" aria-current="page">Accessibility</Link></li>
              </ul>
            </nav>
          </div>
